...
import { transactionalEmailsApi } from '@/utils/brevo';

// --- CONSTANTES ---
const WINDOW_MS = 15 * 60 * 1000; // 15 minutos
const MAX_REQUESTS = 2;
const ALLOWED_ORIGINS = [
  'https://envasadosh2o.com',
  'https://www.envasadosh2o.com',
...
export const POST = async (req) => {
  ...
  try {
    ...
    const sendSmtpEmail = {
      to: [{ email: 'info@envasadosh2o.com' }],
      sender: { email: 'envasadosh2o.platform@gmail.com', name: 'envasadosh2o.com' },
      subject: `Nuevo mensaje de "${fullname}" desde Formulario de Contacto`,
      htmlContent: `
        <h2><strong>Mensaje de "${fullname}" enviado desde el Formulario de Contacto en envasadosh2o.com</strong></h2>
        <br>
        <hr>     
